...
namespace RabbitMQWorkerService.ExcelCreate.Services
{
    public class RabbitMQClientService : IDisposable // dispose olunca bağlantılar kapatılsın
    {
        ...
        // consumer tarafı burası zaten oluştuğunu biliyoruz kuyruğun adını bilmek yeterli
        ...
        public IModel Connect()
        {
            ...
            else
            {
                ...
                // consumer tarafı burası zaten oluştuğunu biliyoruz
